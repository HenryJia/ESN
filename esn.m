function [final_internal_state, W_out, W_in, W, predicted] = esn(x, W_in, W, leaking_rate = 1)
...
[final_internal_state, W_out, W_in, W, predicted] = esn(x, W_in, W, leaking_rate);
...
x = load("stock_data_clean/KAZ_LDX.TXT" )(1:end-200,:);
x_val = load("stock_data_clean/KAZ_LDX.TXT" )(end-199:end,:);
[x_norm, mu, sigma] = feat  leaking_rate;ureNormalize(x);
